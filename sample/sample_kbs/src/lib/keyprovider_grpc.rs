...
const METHOD_KEY_PROVIDER_SERVICE_WRAP_KEY: ::grpcio::Method<super::keyprovider::keyProviderKeyWrapProtocolInput, super::keyprovider::keyProviderKeyWrapProtocolOutput> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/keyprovider.KeyProviderService/WrapKey",
...
impl KeyProviderServiceClient {
    ...
    pub fn wrap_key_opt(&self, req: &super::keyprovider::keyProviderKeyWrapProtocolInput, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::keyprovider::keyProviderKeyWrapProtocolOutput> {
        self.client.unary_call(&METHOD_KEY_PROVIDER_SERVICE_WRAP_KEY, req, opt)
    }

    pub fn wrap_key(&self, req: &super::keyprovider::keyProviderKeyWrapProtocolInput) -> ::grpcio::Result<super::keyprovider::keyProviderKeyWrapProtocolOutput> {
        self.wrap_key_opt(req, ::grpcio::CallOption::default())
    }

    pub fn wrap_key_async_opt(&self, req: &super::keyprovider::keyProviderKeyWrapProtocolInput, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::keyprovider::keyProviderKeyWrapProtocolOutput>> {
        self.client.unary_call_async(&METHOD_KEY_PROVIDER_SERVICE_WRAP_KEY, req, opt)
    }

    pub fn wrap_key_async(&self, req: &super::keyprovider::keyProviderKeyWrapProtocolInput) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::keyprovider::keyProviderKeyWrapProtocolOutput>> {
        self.wrap_key_async_opt(req, ::grpcio::CallOption::default())
    }
...
pub trait KeyProviderService {
    fn wrap_key(&mut self, ctx: ::grpcio::RpcContext, req: super::keyprovider::keyProviderKeyWrapProtocolInput, sink: ::grpcio::UnarySink<super::keyprovider::keyProviderKeyWrapProtocolOutput>);
...
pub fn create_key_provider_service<S: KeyProviderService + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    ...
    builder = builder.add_unary_handler(&METHOD_KEY_PROVIDER_SERVICE_WRAP_KEY, move |ctx, req, resp| {
        instance.wrap_key(ctx, req, resp)
    });
    let mut instance = s;
